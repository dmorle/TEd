...
TEDLANG_API void         te_scope_free    (te_scope_st* pself);
...
TEDLANG_API te_obj_st**  te_scope_get     (te_scope_st* pself, const char* name);
// set will steals the pobj pointer, name is copied if nessisary
TEDLANG_API te_scope_st* te_scope_set     (te_scope_st* pself, const char* name, te_obj_st* pobj);
// removes an element from the hashmap if it exists, else noop
TEDLANG_API void         te_scope_rm      (te_scope_st* pself, const char* name);
