...
TEDLANG_API bool te_null_bool(te_obj_st* pself);
TEDLANG_API const char* te_null_repr(te_obj_st* pself);

TEDLANG_API te_obj_st* te_null_eq(te_obj_st* pself, te_obj_st* plval);
TEDLANG_API te_obj_st* te_null_ne(te_obj_st* pself, te_obj_st* plval);
